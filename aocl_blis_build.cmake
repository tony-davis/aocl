...
file(APPEND "${BLAS_BUILD_LOG_FILE_PATH}" "CONFIGURATION COMMAND: cmake -G \"${CMAKE_GENERATOR}\" -S ${BLAS_DIR} -B ${CMAKE_BINARY_DIR}/blis/build_dir -DCMAKE_CONFIGURATION_TYPES=${CMAKE_CONFIGURATION_TYPES} -DBLIS_CONFIG_FAMILY=${BLIS_CONFIG_FAMILY} -DENABLE_CBLAS=${ENABLE_CBLAS} -DENABLE_ADDON=${ENABLE_ADDON} -DENABLE_THREADING=${ENABLE_THREADING} -DOpenMP_libomp_LIBRARY=${OpenMP_libomp_LIBRARY} -DBLAS_INT_SIZE=${BLAS_INT_SIZE} -DCOMPLEX_RETURN=${COMPLEX_RETURN} -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DENABLE_TRSM_PREINVERSION=${ENABLE_TRSM_PREINVERSION} -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/blis/install_package -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}.\n")

# Execute the configuration command
# Note: CompilerToolSet must be passed as separate arguments to ensure proper cmake argument parsing
# When using Ninja or Makefiles, CompilerToolSet contains "-DCMAKE_C_COMPILER=... -DCMAKE_CXX_COMPILER=..."
# When using Visual Studio, CompilerToolSet contains "-T<toolset>"
execute_process(
    COMMAND cmake -G ${CMAKE_GENERATOR} -S ${BLAS_DIR} -B ${CMAKE_BINARY_DIR}/blis/build_dir 
        -DCMAKE_CONFIGURATION_TYPES=${CMAKE_CONFIGURATION_TYPES} 
        -DBLIS_CONFIG_FAMILY=${BLIS_CONFIG_FAMILY} 
        -DENABLE_CBLAS=${ENABLE_CBLAS} 
        -DENABLE_ADDON=${ENABLE_ADDON} 
        -DENABLE_THREADING=${ENABLE_THREADING} 
        -DOpenMP_libomp_LIBRARY=${OpenMP_libomp_LIBRARY} 
        -DBLAS_INT_SIZE=${BLAS_INT_SIZE} 
        -DCOMPLEX_RETURN=${COMPLEX_RETURN} 
        -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} 
        -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} 
        -DENABLE_TRSM_PREINVERSION=${ENABLE_TRSM_PREINVERSION} 
        -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/blis/install_package 
